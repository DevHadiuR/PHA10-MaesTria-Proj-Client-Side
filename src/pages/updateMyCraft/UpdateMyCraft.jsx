      ...
      .then((value) => {
        ...
        if (value.acknowledged) {
          Swal.fire({
            ...
            text: "Your Sculpture is Successfully Updated!",
            icon: "success",
          });
          reset();
        }
            ...
            <div className="hero-content flex flex-col  gap-6">
              <div className="text-center w-full flex-1 ">
                ...
                <p className="py-6 w-full md:w-[80%] mx-auto font-serif text-lg md:text-xl text-white opacity-85">
                  ...
                  boundless possibilities as you update, enhance, and breathe
                  new life into your sculptures, ensuring they authentically
                  reflect the depth of your evolving vision and the mastery of
                  your skill, imbuing each piece with renewed vitality,
