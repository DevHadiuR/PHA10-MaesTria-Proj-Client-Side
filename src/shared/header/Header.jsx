...
const Header = () => {
    ...
    <>
      <li>
        <NavLink
          ...
          style={({ isActive }) => {
            return {
              border: isActive ? "2px solid gray" : "none",
  ...
  return (
    <div className="navbar bg-base-100 shadow-lg md:py-4 md:px-6">
      ...
      <div className="navbar-end">
        <div className="hidden md:flex items-center">
          <div className="avatar cursor-pointer border-blue-400 border-2 rounded-full mr-2">
